...
<div class="woocommerce-order">
	...
	<?php if ( $order ) :
        ...
        <?php else : ?>
            ...
            <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', __('Thank you. Your order has been received.', 'materialis'), $order); ?></p>
        ...
        <div class="woocommerce-thank-you-wrapper">
            <div class="col-xs">
                <div class="woocommerce-payment-method">
